...
const pages = {
  ...
  gfcrIndicatorSet: {
    ...
    getF2_1a: () => <><b>Coral reef area</b> of MPAs and OECMs (as aligned to GBF Target 3)</>,
    f2_1a_helper: 'F2.1a Helper Text',
    getF2_1b: () => <><b>Total area</b> of MPAs and OECMs (as aligned to GBF Target 3)</>,
    f2_1b_helper: 'F2.1b Helper Text',
    getF2_2a: () => <><b>Coral reef area</b> of locally managed areas / co-managed areas</>,
    f2_2a_helper: 'F2.2a Helper Text',
    getF2_2b: () => <><b>Total area</b> of locally managed areas / co-managed areas</>,
    f2_2b_helper: 'F2.2b Helper Text',
    getF2_3a: () => <><b>Coral reef area</b> of fisheries management</>,
    f2_3a_helper: 'F2.3a Helper Text',
    getF2_3b: () => <><b>Total area</b> of fisheries management</>,
    ...
    getF5_1: () => <>Number of <b>local communities</b> engaged in meaningful participation and co-development</>,
    f5_1_helper: 'F5.1 Helper Text',
    getF5_2: () => <>Number of <b>local organizations</b> engaged in meaningful participation and co-development</>,
    ...
    getF7_1: () => <>Total <b>direct beneficiaries</b> (disaggregated by gender, age, Indigenous peoples)</>,
    getF7_2: () => <>Total <b>indirect beneficiaries</b> (disaggregated by gender, age, Indigenous peoples)</>,
