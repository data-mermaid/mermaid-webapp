const genericObservationsValidations = [
  [
    {
...
export default {
  ...
  results: {
    data: {
      ...
      obs_colonies_bleached: genericObservationsValidations,
      obs_quadrat_benthic_percent: genericObservationsValidations,
      ...
      quadrat_collection: {
        ...
        depth: [
          {
            code: 'required',
            fields: ['data.quadrat_collection.depth'],
            status: 'error',
            context: null,
        ...
        width: [
          {
            code: 'required',
            fields: ['data.quadrat_collection.width'],
            status: 'error',
            context: null,
        ...
        number: [
          {
            code: 'required',
            fields: ['data.quadrat_collection.number'],
            status: 'error',
            context: null,
        ...
        size_bin: [
          {
            code: 'required',
            fields: ['data.quadrat_collection.size_bin'],
            status: 'error',
            context: null,
