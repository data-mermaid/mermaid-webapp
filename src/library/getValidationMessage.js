...
} from './validationMessageHelpers'

export const getValidationMessage = (validation, projectId = '') => {
  const { code, context, fields } = validation

  const validationMessages = {
    all_attributes_same_category: () =>
      i18n.t('validation_messages.all_attributes_same_category', { category: context?.category }),
    ...
    duplicate_values: () =>
      fields?.length
        ...
        : i18n.t('validation_messages.duplicate_values_simple'),
    ...
    high_density: () =>
      i18n.t('validation_messages.high_density', { max: context?.biomass_range[1] }),
    ...
    max_interval_size: () =>
      i18n.t('validation_messages.max_interval_size', { max: context?.interval_size_range[1] }),
    max_interval_start: () =>
      i18n.t('validation_messages.max_interval_start', { max: context?.interval_start_range[1] }),
    invalid_benthic_transect: () => i18n.t('validation_messages.invalid_benthic_transect'),
    invalid_depth: () =>
      i18n.t('validation_messages.invalid_depth', { min: context?.depth_range[0] }),
    excessive_precision: () =>
      i18n.t('validation_messages.excessive_precision', { places: context?.decimal_places }),
    ...
    invalid_number_of_points: () =>
      i18n.t('validation_messages.invalid_number_of_points', {
        quadratNumbers: context?.invalid_quadrat_numbers,
      }),
    ...
    max_quadrat_size: () =>
      i18n.t('validation_messages.max_quadrat_size', { max: context?.quadrat_size_range[1] }),
    ...
    low_density: () =>
      i18n.t('validation_messages.low_density', { min: context?.biomass_range[0] }),
    management_not_found: () => i18n.t('validation_messages.management_not_found'),
    max_depth: () => i18n.t('validation_messages.max_depth', { max: context?.depth_range[1] }),
    max_fish_size: () => i18n.t('validation_messages.max_fish_size'),
    minimum_total_fish_count: () =>
      i18n.t('validation_messages.minimum_total_fish_count', { min: context?.minimum_fish_count }),
    ...
    obs_total_length_toolarge: () =>
      i18n.t('validation_messages.obs_total_length_toolarge', {
        totalObsLength: context?.total_obs_length,
        lenSurveyed: context?.len_surveyed,
      }),
    ...
    sample_time_out_of_range: () =>
      i18n.t('validation_messages.sample_time_out_of_range', {
        min: context?.time_range[0],
        max: context?.time_range[1],
      }),
