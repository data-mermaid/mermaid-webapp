...
const HttpResponseErrorHandlerProvider = ({ children, value }) => {
  return <HttpResponseErrorHandlerContext.Provider value={value}>{children}</HttpResponseErrorHandlerContext.Provider>
}
...
const useHttpResponseErrorHandler = () => {
  ...
  if (context === undefined) {
    throw new Error('useHttpResponseErrorHandler must be used within a HttpResponseErrorHandlerProvider component')
  }
