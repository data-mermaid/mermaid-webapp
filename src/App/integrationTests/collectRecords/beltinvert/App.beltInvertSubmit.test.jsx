...
test('Submit macroinvertebrate success shows toast message and redirects to collect record list page', async () => {
...
test('Submit macroinvertebrate failure shows toast message and an enabled submit button', async () => {
