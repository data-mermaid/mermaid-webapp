...
test('Validating an empty collect record, and then editing an input with errors shows the errors until the save button is pressed. Validations show when the validation button is clicked again.', async () => {
  ...
  expect(within(screen.getByTestId('interval-size')).getByText('validation_messages.required')).toBeInTheDocument()
  expect(within(screen.getByTestId('interval-start')).getByText('validation_messages.required')).toBeInTheDocument()
  ...
  expect(within(screen.getByTestId('len-surveyed')).queryByText('validation_messages.required')).not.toBeInTheDocument()
  expect(within(screen.getByTestId('reef-slope')).queryByText('validation_messages.required')).not.toBeInTheDocument()
