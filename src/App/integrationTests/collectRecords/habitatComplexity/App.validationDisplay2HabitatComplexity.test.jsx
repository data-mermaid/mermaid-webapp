...
test('Validating an empty Habitat Complexity collect record shows validations (proof of wire-up)', async () => {
...
test('Habitat Complexity validations will show only the first error when there are multiple errors and warnings', async () => {
  const { dexiePerUserDataInstance, dexieCurrentUserInstance } = getMockDexieInstancesAllSuccess()
