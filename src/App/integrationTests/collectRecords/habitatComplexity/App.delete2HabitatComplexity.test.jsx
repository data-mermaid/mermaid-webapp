...
describe('Offline', () => {
  test('Delete Habitat Complexity prompt cancel closes prompt and does nothing (edits persisted)', async () => {
    ...
    await user.click(within(modal).getByTestId('delete-record-cancel-button'))
