...
const GfcrIndicatorSetNav = ({ selectedNavItem, setSelectedNavItem }) => {
  ...
  return (
    <StyledNav>
      <NavHeader>{t('gfcr_nav.fund_indicators_heading')}</NavHeader>
      <NavSubHeader
      ...
      >
        {t('gfcr_nav.report_title_and_date_heading')}
      </NavSubHeader>
      <NavList>
        <NavListItem
          id="f1"
        ...
        >
          <FText>F7</FText>
          <LiText>{t('gfcr_nav.f7')}</LiText>
        </NavListItem>
      </NavList>
      <NavHeader>{t('gfcr_nav.f8_f9_f10_heading')}</NavHeader>
      <NavSubHeader
